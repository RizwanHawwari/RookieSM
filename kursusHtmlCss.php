                    ...
                    <div class="col-md-4"> <!-- Adjusted column size -->
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-center">Pembelajaran PPLG</h3>
                            </div>
                            <div class="card-body text-center">
                                <div class="product-box section" id="html-css-course">
                                    <img src="img-logo/htmlcss-removebg-preview.png" alt="HTML & CSS" 
                                         class="product-img" 
                                    ...
                                    <div class="path">
                                        <a href="learningHtml.php" class="btn btn-primary">Learn</a>
                                    </div>
                                </div>
                            </div>
                        </div>
