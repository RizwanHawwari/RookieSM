...
<head>
  ...
  <title>Jaringan Komputer | Course</title>
  <style>
    .break {
      height: 65px;
...
<body>
  ...
  <section class="video-section">
    <div class="container">
      <h2 class="text-center">Belajar Jaringan Komputer Untuk Pemula</h2>
      <hr class="video-underline">
      <div class="video-container text-center">
      <iframe width="560" height="315" src="https://www.youtube.com/embed/3QhU9jd03a0?si=LjtQ0l175mklWKR-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
    </div>
  </section>
